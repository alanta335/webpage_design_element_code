        ...
        for (let b = a; b < particleArray.length; b++) {
            ...
            if (distance < 500) {
                ...
                if (mouseDistance < mouse.radius / 2) {
                    particleArray[a].size = 7;
                    ctx.strokeStyle = 'rgba(190,69,0,' + opacityValue + ')';
                } else if (mouseDistance < mouse.radius - 50) {
                    particleArray[a].size = 6;
                    ctx.strokeStyle = 'rgba(230,69,0,' + opacityValue + ')';
                } else if (mouseDistance < mouse.radius + 20) {
                    particleArray[a].size = 5;
                    ctx.strokeStyle = 'rgba(255,69,0,' + opacityValue + ')';
                } else {
